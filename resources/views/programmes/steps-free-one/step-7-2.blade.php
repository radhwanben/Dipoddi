      <fieldset id="step7 ">
        ...
        <div class="row card-deck" style="display: flex; justify-content: center; margin-top: 50px;gap:40px">
          <div class="card card-deck mb-2 col-md-2 oncklick" id="cardPuissance" data-radio-button-id="puissaance">
            ...
            <div class="card-body">
              ...
              <div class="radio-wrapper">
                <input type="radio" value="Puissance" id="puissaance" name="target_cardio">
                <label for="puissaance">
                  <div class="tick_mark"></div>
                </label>
              </div>
            </div>
          </div>
          <div class="card mb-2 col-md-2 oncklick" id="cardEndurance" data-radio-button-id="endurance">
            ...
            <div class="card-body">
              ...
              <div class="radio-wrapper">
                <input type="radio" value="Endurance" id="endurance" name="target_cardio">
                <label for="endurance">
                  <div class="tick_mark"></div>
                </label>
              </div>
          ...
          <div class="card mb-2 col-md-2 oncklick" id="cardResistance" data-radio-button-id="resistance">
            ...
            <div class="card-body">
              ...
              <div class="radio-wrapper">
                <input type="radio" value="Resistance" id="resistance" name="target_cardio">
          ...
          <div class="card mb-2 col-md-2  oncklick" id="cardSprint" data-radio-button-id="sprint">
            ...
            <div class="card-body">
              ...
              <div class="radio-wrapper">
                <input type="radio" value="Sprint" id="sprint" name="target_sprint">
                <label for="sprint">
                  <div class="tick_mark"></div>
                </label>
              </div>
